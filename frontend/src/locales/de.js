...
export default {
  ...
  "This browser doesn't support passkeys — you can still use quietGym locally on this device.": 'Dieser Browser unterstützt keine Passkeys — du kannst quietGym trotzdem lokal auf diesem Gerät nutzen.',
  ...
  'to install quietGym as a full-screen app.': 'um quietGym als Vollbild-App zu installieren.',
  ...
  'Rest-timer alerts, even if quietGym is closed.': 'Pausen-Timer-Alarm, auch wenn quietGym geschlossen ist.',
  ...
  'A small file a friend imports into their own quietGym — routines only, none of your workouts or weigh-ins.': 'Eine kleine Datei, die ein Freund in sein eigenes quietGym importiert — nur Routinen, keine Workouts oder Wiegungen.',
  ...
  'this isn’t an quietGym plan file': 'das ist keine quietGym-Plandatei',
  'Shared routine': 'Geteilte Routine',
  'Unknown exercise': 'Unbekannte Übung',
  'Weekly Training Plan': 'Wochen-Trainingsplan',
  'Made with quietGym': 'Erstellt mit quietGym',
  ...
  'Reload quietGym': 'quietGym neu laden',
