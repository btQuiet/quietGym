...
export default {
  ...
  'This demo runs entirely in your browser on example data — nothing is sent anywhere. Password sign-in and sync across your devices come with the quietGym server, which you get by self-hosting it.': 'Esta demo funciona completamente en tu navegador con datos de ejemplo; no se envía nada. El acceso con contraseña y la sincronización entre dispositivos están disponibles al alojar tu propio servidor quietGym.',
  'Your workouts. Your weights. Your data.': 'Tus entrenamientos. Tus pesos. Tus datos.',
  'Your server password protects access to your synced data.': 'La contraseña del servidor protege el acceso a tus datos sincronizados.',
  'Signs the account out on every device, including this one. Sign in with your password again anytime.': 'Cierra la sesión de la cuenta en todos los dispositivos, incluido este. Podrás volver a entrar con tu contraseña.',
  'Password sign-in, sync across your devices, your own data.': 'Acceso con contraseña, sincronización entre dispositivos y tus propios datos.',
  'Owner account': 'Cuenta del propietario',
  'Signed in — data syncs across your devices.': 'Sesión iniciada; los datos se sincronizan entre tus dispositivos.',
  'Your data is synced to the server first, then cleared from this device.': 'Tus datos se sincronizan primero con el servidor y después se eliminan de este dispositivo.',
  'Ends the account sessions on all your devices.': 'Cierra las sesiones de la cuenta en todos tus dispositivos.',
  'Sign in required': 'Debes iniciar sesión',
  'synced with your account': 'sincronizado con tu cuenta',
  'Your data syncs with your account — sign in anywhere to see it.': 'Tus datos se sincronizan con tu cuenta; inicia sesión desde cualquier lugar para verlos.',
  'Confirm': 'Confirmar',
  'Cancel': 'Cancelar',
  'Delete': 'Eliminar',
  'Save': 'Guardar',
  ...
  "This browser doesn't support passkeys — you can still use quietGym locally on this device.": 'Este navegador no admite passkeys — aun así puedes usar quietGym localmente en este dispositivo.',
  ...
  'to install quietGym as a full-screen app.': 'para instalar quietGym como app a pantalla completa.',
  ...
  'Rest-timer alerts, even if quietGym is closed.': 'Avisos del temporizador de descanso, incluso con quietGym cerrado.',
  ...
  'A small file a friend imports into their own quietGym — routines only, none of your workouts or weigh-ins.': 'Un archivo pequeño que un amigo importa en su propio quietGym: solo rutinas, ninguno de tus entrenamientos ni pesajes.',
  ...
  'Reload quietGym': 'Recargar quietGym',
