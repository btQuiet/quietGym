...
export default {
  ...
  "This browser doesn't support passkeys — you can still use quietGym locally on this device.": 'Este navegador não suporta passkeys — ainda assim podes usar o quietGym localmente neste dispositivo.',
  ...
  'to install quietGym as a full-screen app.': 'para instalar o quietGym como app em ecrã inteiro.',
  ...
  'Rest-timer alerts, even if quietGym is closed.': 'Alertas do temporizador de descanso, mesmo com o quietGym fechado.',
  ...
  'A small file a friend imports into their own quietGym — routines only, none of your workouts or weigh-ins.': 'Um pequeno ficheiro que um amigo importa no seu próprio quietGym — apenas rotinas, nenhum dos teus treinos ou pesagens.',
  ...
  'Reload quietGym': 'Recarregar quietGym',
