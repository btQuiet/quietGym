...
export default {
  ...
  "This browser doesn't support passkeys — you can still use quietGym locally on this device.": 'Этот браузер не поддерживает ключи доступа — но quietGym можно использовать локально на этом устройстве.',
  ...
  'to install quietGym as a full-screen app.': 'чтобы установить quietGym как полноэкранное приложение.',
  ...
  'Rest-timer alerts, even if quietGym is closed.': 'Оповещения таймера отдыха, даже если quietGym закрыт.',
  ...
  'A small file a friend imports into their own quietGym — routines only, none of your workouts or weigh-ins.': 'Небольшой файл, который друг импортирует в свой quietGym — только программы, без твоих тренировок и взвешиваний.',
  ...
  'Reload quietGym': 'Перезагрузить quietGym',
