...
export default {
  ...
  "This browser doesn't support passkeys — you can still use quietGym locally on this device.": 'Bu tarayıcı geçiş anahtarlarını desteklemiyor — yine de quietGym’i bu cihazda yerel olarak kullanabilirsin.',
  ...
  'to install quietGym as a full-screen app.': 'ile quietGym’i tam ekran uygulama olarak kurabilirsin.',
  ...
  'Rest-timer alerts, even if quietGym is closed.': 'quietGym kapalıyken bile dinlenme sayacı uyarıları.',
  ...
  'A small file a friend imports into their own quietGym — routines only, none of your workouts or weigh-ins.': 'Bir arkadaşının kendi quietGym\'ine aktardığı küçük bir dosya — yalnızca rutinler, antrenmanların veya tartıların değil.',
